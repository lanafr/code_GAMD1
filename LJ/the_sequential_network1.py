...
class f1(nn.Module):
    def __init__(self, encoding_size):
        ...
        #self.func25 = MLP(embed2, embed2, hidden_layer=4, hidden_dim=512, activation='softplus')
        #self.func26 = MLP(embed2, embed2, hidden_layer=4, hidden_dim=512, activation='softplus')
...
class ODEBlock(nn.Module):
    ...
    def forward(self, x, integration_time):
        out = odeint(self.odefunc, x, integration_time, method = 'rk4', atol=1e-6, rtol=1e-6)
...
def main():
    ...
    parser.add_argument('--cp_dir', default='./model_ckpt/sequential_network_original')
